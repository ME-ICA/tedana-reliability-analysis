# Contributing to `tedana-reliability-analysis`

Welcome to the `tedana-reliability-analysis` repository! We're excited you're here and want to contribute.
...
`tedana-reliability-analysis` is a young project maintained by a growing group of enthusiastic developers&mdash; and we're excited to have you join!
...
As a reminder, we expect all contributions to `tedana-reliability-analysis` to adhere to our [code of conduct][link_coc].
...
The following outlines how the ``tedana-reliability-analysis`` developers think about these different tools.
...
* **Milestones** are the link between the issues and the high level strategy for the ``tedana-reliability-analysis`` project.
Contributors new and old are encouraged to take a look at the milestones to see how we are progressing
towards ``tedana-reliability-analysis``'s shared vision.
...
The ``tedana-reliability-analysis``  maintainers use this board to keep an eye on how tasks are progressing week by week.
...
We appreciate all contributions to tedana-reliability-analysis, but those accepted fastest will follow a workflow similar to the following:

**1. Comment on an existing issue or open a new issue referencing your addition.**

This allows other members of the tedana-reliability-analysis development team to confirm that you aren't overlapping with work that's currently underway and that everyone is on the same page with the goal of the work you're going to carry out.

[This blog][link_pushpullblog] is a nice explanation of why putting this work in up front is so useful to everyone involved.

**2. [Fork][link_fork] the [tedana-reliability-analysis repository][link_tedana-reliability-analysis] to your profile.**

This is now your own unique copy of tedana-reliability-analysis. Changes here won't effect anyone else's work, so it's a safe space to explore edits to the code!
...
When you're creating your pull request, please make sure to review the tedana-reliability-analysis [style conventions](#style-guide).

Note that to test a change, you may need to set up your local repository to run a tedana-reliability-analysis workflow.
To do so, run
```
...
The documentation for `tedana-reliability-analysis` is written using [ReStructuredText][restructuredtext].
...
to provide an easily accessible space for accessing `tedana-reliability-analysis` documentation.
...
[link_tedana-reliability-analysis]: https://github.com/ME-ICA/tedana-reliability-analysis
...
[link_issues]: https://github.com/ME-ICA/tedana-reliability-analysis/issues
[link_milestones]: https://github.com/ME-ICA/tedana-reliability-analysis/milestones/
[link_project_boards]: https://github.com/ME-ICA/tedana-reliability-analysis/projects
[link_gitter]: https://gitter.im/me-ica/tedana-reliability-analysis
[link_coc]: https://github.com/ME-ICA/tedana-reliability-analysis/blob/master/CODE_OF_CONDUCT.md

[link_labels]: https://github.com/ME-ICA/tedana-reliability-analysis/labels
[link_bugs]: https://github.com/ME-ICA/tedana-reliability-analysis/labels/bug
[link_helpwanted]: https://github.com/ME-ICA/tedana-reliability-analysis/labels/help%20wanted
[link_enhancement]: https://github.com/ME-ICA/tedana-reliability-analysis/labels/enhancement
...
[link_contributors]: https://github.com/ME-ICA/tedana-reliability-analysis/graphs/contributors
